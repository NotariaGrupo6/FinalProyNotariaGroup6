...
public class PersonaBene {
    ...
    public PersonaBene(int TB_PERSONA, int TB_BENEFICIARIO_ID, int BENEFICIARIO_ID, String PER_DNI_T, String PER_NOMBRE_T, String PER_APEPAT_T, String PER_APEMAT_T, String TRA_DESCRIP_T, String PER_DNI_D, String PER_NOMBRE_D, String PER_APEPAT_D, String PER_APEMAT_D, String TRA_DESCRIP_D, Date TRA_REG) {
